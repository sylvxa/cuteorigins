...
import lol.sylvie.cuteorigins.state.compat.CuteOriginsFileFix;
...
public abstract class DataFixersMixin {
    ...
    private static Schema cuteorigins$addFileFix(Schema original,
                                                 @Local(argsOnly = true) FileFixerUpper.Builder fileFixerUpper) {
        fileFixerUpper.addFixer(new CuteOriginsFileFix(original));
        return original;
    }
}